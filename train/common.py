...
def make_training_clip(
    ...
    rng: np.random.Generator, fret_onset: str = "segment", fret_onset_k: float = 1.0,
    ...
    fret_target, strum = compute_frame_labels(grad_only.notes, train_window_s, fps, hit_window_s, fret_onset, fret_onset_k)
